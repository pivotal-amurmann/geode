...
public class PutRequestOperationHandler
  ...
  public RegionAPI.PutResponse process(SerializationService serializationService,
    ...
    try {
      ...
      Object decodedValue = decode(serializationService, entry.getValue());
      Object decodedKey = decode(serializationService, entry.getKey());
  ...
  private Object decode(SerializationService serializationService,
