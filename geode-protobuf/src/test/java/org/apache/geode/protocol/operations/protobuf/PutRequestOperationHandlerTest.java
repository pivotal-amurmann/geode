...
public class PutRequestOperationHandlerTest {
  public static final String TEST_KEY = "my key";
  public static final int TEST_VALUE = 99;
  ...
  public void setUp() throws Exception {
    ...
    when(serializationServiceStub.decode(BasicTypes.EncodingType.INT,
        ByteBuffer.allocate(4).putInt(TEST_VALUE).array())).thenReturn(TEST_VALUE);
  ...
  public void test_puttingTheEncodedEntryIntoRegion() throws UnsupportedEncodingTypeException,
    ...
    RegionAPI.PutResponse response =
        operationHandler.process(serializationServiceStub, makePutRequest(), cacheStub);
  ...
  private RegionAPI.PutRequest makePutRequest() throws CodecNotRegisteredForTypeException,
    ...
    BasicTypes.EncodedValue.Builder value =
        BasicTypes.EncodedValue.newBuilder().setEncodingType(BasicTypes.EncodingType.INT)
            .setValue(ByteString.copyFrom(ByteBuffer.allocate(4).putInt(TEST_VALUE).array()));
    ...
    putRequestBuilder.setRegionName(TEST_REGION).setEntry(entry);
