...
public class PutAllRequestOperationHandlerJUnitTest {
  ...
  public void setUp() throws Exception {
    ...
    addStringMockEncoding(serializationServiceStub, TEST_KEY1);
    addStringMockEncoding(serializationServiceStub, TEST_KEY2);
    addStringMockEncoding(serializationServiceStub, TEST_KEY3);
    addStringMockEncoding(serializationServiceStub, TEST_INVALID_KEY);
    addStringMockEncoding(serializationServiceStub, TEST_VALUE1);
    addStringMockEncoding(serializationServiceStub, TEST_VALUE2);
    addStringMockEncoding(serializationServiceStub, TEST_VALUE3);
  ...
  private void addStringMockEncoding(SerializationService mock, String s) throws Exception {
